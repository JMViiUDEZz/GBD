-- JOSÉ MARÍA VIÚDEZ PARRA                                               1ºASIR
...
INSERT INTO PROFESORES VALUES (9,'ANA VICENTE','BELMONTE','HUERCAL-OVERA','2019-09-01','INFORMATICA','M',1600)
INSERT INTO PROFESORES VALUES (10,'DANIEL','CANO','ALBACETE','2022-09-01','INFORMATICA','H',1575)
...
INSERT INTO ALUMNOS (NOMBRE,APELLIDOS,CODAL,CIUDAD,FECHANACIMIENTO) VALUES ('ANA','ZAPATA LOPEZ',12,'ZURGENA','2000-03-12')
-- 3.	Introducir datos de 6 asignaturas.
INSERT INTO ASIGNATURAS VALUES ('FOL','FORMACION Y ORIENTACION LABORAL','1','ASIR')
INSERT INTO ASIGNATURAS VALUES ('SAD','SEGURIDAD Y ALTA DISPONIBILIDAD','2','ASIR')
...
INSERT INTO NOTAS VALUES (8,'PAR',SUBDATE(CURRENT_DATE(),INTERVAL 1 DAY),9)
INSERT INTO NOTAS VALUES (8,'FOL',CURRENT_DATE(),10)
...
SELECT NOMBRE,APELLIDOS FROM PROFESORES WHERE DEPARTAMENTO='FRANCES' AND (CIUDAD='HUERCAL-OVERA' OR CIUDAD='MURCIA') AND SEXO='M'
...
SELECT AVG(NOTA) FROM NOTAS N NATURAL JOIN ALUMNOS AL INNER JOIN ASIGNATURAS A ON N.CODAS=A.CODAS WHERE AL.NOMBRE='Emilio' AND AL.APELLIDOS='Parra Sanz' AND A.NOMBRE='Planificación y Admon de Redes'
...
SELECT A.CODAS,A.NOMBRE,AVG(NOTA) FROM NOTAS N NATURAL JOIN ALUMNOS AL INNER JOIN ASIGNATURAS A ON N.CODAS=A.CODAS WHERE AL.NOMBRE='Emilio' AND AL.APELLIDOS='Parra Sanz' GROUP BY 
A.CODAS,A.NOMBRE
...
SELECT * FROM PROFESORES WHERE SUELDO > ALL (SELECT SUELDO FROM PROFESORES WHERE DEPARTAMENTO='INFORMATICA')
...
SELECT * FROM PROFESORES WHERE SUELDO > ANY (SELECT SUELDO FROM PROFESORES WHERE DEPARTAMENTO='INFORMATICA')
